<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccumulatedVacation.aspx.cs" Inherits="Integration.Pages.AccumulatedVacation" %>
                ...
                <div class="recent-grid">
                    <div class="projects">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table width="100%">
                                    <asp:GridView ID="GridView1" runat="server" width="100%" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="9"></asp:GridView>
                                </table>
                            </div>
                        </div>
                    </div>
