    ...
    public partial class TotalEarning : System.Web.UI.Page
    {
        ...
        private void SelectQuery()
        {
            ...
            string sql = "SELECT CAST(Personal.Employee_ID AS integer) AS 'Employee ID', First_Name AS 'Name', Shareholder_Status As 'Shareholder', " +
                " IIF(Gender=1,'Male','Female') AS Gender, Ethnicity, Employment_Status AS 'Employment', Department " +
            ...
            {
                string query = "select idEmployee AS 'Employee ID',`Paid To Date`, `Paid Last Year` from Employee " +
