<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BenefitsPaid.aspx.cs" Inherits="Integration.Pages.BenefitsPaid" %>
            ...
            <div class="recent-grid">
                <div class="projects">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table width="100%">
                                <asp:GridView ID="GridView1" runat="server" width="100%" AllowPaging="True" PageSize="1" OnPageIndexChanging="GridView1_PageIndexChanging" ></asp:GridView>
                            </table>
                        </div>
                    </div>
                </div>
